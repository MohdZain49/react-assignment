...
function OrderSummary() {
  return (
    <div className="h-67.75 bg-[#FFFFFF] flex flex-col gap-4 p-8 border border-[#E5E7EB] rounded-[10px]">
      ...
      <div className="lg:h-27.25 rounded-sm py-5 pl-6 border border-[#4388FF4D] shadow-[0px_1px_2px_-1px_#0000001A,0px_1px_3px_0px_#0000001A]">
        <div className="flex justify-between items-center h-12.5">
          <p className="w-30 lg:w-44.75 pb-2">
            <span className="text-xl md:text-3xl font-extrabold leading-9 text-[#111827]">
              ₹4,999
            </span>
          ...
          <div className="w-32 pb-4 mt-4">
            <p className="text-xs font-bold leading-4 tracking-[1.2px] text-[#1977F2]">
              SELECTED PLAN
            </p>
            <p className="text-sm md:text-xl font-bold leading-7 text-[#111827]">
              Startup
            </p>
          </div>
        </div>
